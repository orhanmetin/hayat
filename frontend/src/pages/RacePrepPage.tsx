...
import type { RacePrepOverview } from "../types/modules";
...
const GoalCard: React.FC<GoalCardProps> = ({
  ...
  <div className="rounded-2xl bg-white dark:bg-black/20 border border-slate-200 dark:border-white/5 p-5 flex flex-col gap-4 shadow-sm">
...
export const RacePrepPage: React.FC = () => {
  ...
  const handleIncrementVisualization = async () => {
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-11 h-11 rounded-2xl bg-fuchsia-500 hover:bg-fuchsia-600 disabled:opacity-50 text-white flex items-center justify-center shrink-0 transition-colors shadow-sm"
