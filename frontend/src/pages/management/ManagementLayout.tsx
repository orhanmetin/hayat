...
import { Target, Layers, BookOpen, ClipboardList, Smartphone } from "lucide-react";
...
const sections = [
  ...
  { to: "/management/shortcuts", label: "Shortcuts", icon: Smartphone },
] as const;
...
export const ManagementLayout: React.FC = () => (
  <div className="space-y-6 max-w-xl mx-auto">
    ...
    <nav
      className="grid grid-cols-3 sm:grid-cols-5 gap-1.5 p-1 rounded-xl bg-slate-100 dark:bg-white/5"
